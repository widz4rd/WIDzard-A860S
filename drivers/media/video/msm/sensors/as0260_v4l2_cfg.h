...
static struct msm_camera_i2c_reg_conf as0260_recommend_settings[] = {
	...
	{0x3ECC, 0x22B0,}, 	// DAC_LD_0_1
       ...
       {0xD1CA, 0x7AB2,}, 	//  PGA_TABLE_A_DATA_7
       ...
       {0xD1EE, 0x01AE,}, 	//  PGA_TABLE_A_DATA_25
       ...
       {0xD1F8, 0xE9A8,}, 	//  PGA_TABLE_A_DATA_30
       ...
       {0xD216, 0x1353,}, 	//  PGA_TABLE_A_DATA_45
...
{0xD0FA, 0x0110,}, 	//  20130123_SKT_01F0-->0110_PGA_TABLE_CWF_DATA_5
{0xD0FC, 0x28CE,}, 	//  PGA_TABLE_CWF_DATA_6
{0xD0FE, 0x4672,}, 	//  20130123_SKT_4072-->5E72_PGA_TABLE_CWF_DATA_7
...
{0xD108, 0x0131,}, 	//  20130123_0911-->0131_PGA_TABLE_CWF_DATA_12
...
{0xD1B6, 0x5E79,}, 	//  PGA_TABLE_CWF_DATA_99
       ...
       {0xD024, 0x00F0,}, 	//  PGA_TABLE_D65_DATA_0
...
{0xD02E, 0x0070,}, 	//  PGA_TABLE_D65_DATA_5
       {0xD030, 0x28CE,}, 	//  PGA_TABLE_D65_DATA_6
{0xD032, 0x3872,}, 	//  PGA_TABLE_D65_DATA_7
       {0xD034, 0x2C2E,}, 	//  PGA_TABLE_D65_DATA_8
       {0xD036, 0xA273,}, 	//  PGA_TABLE_D65_DATA_9
       {0xD038, 0x0130,}, 	//  PGA_TABLE_D65_DATA_10
       {0xD03A, 0xB4ED,}, 	//  PGA_TABLE_D65_DATA_11
...
{0xD042, 0x0850,}, 	//  PGA_TABLE_D65_DATA_15
       ...
       {0xD056, 0x13AD,}, 	//  PGA_TABLE_D65_DATA_25
	...
	{0xD01C, 0x8C, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_LO_0
	{0xD01D, 0x82, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_LO_1
	{0xD01E, 0x00, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_LO_2
	{0xD01F, 0xFF, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_0
	{0xD020, 0x90, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_1
	{0xD021, 0x87, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_2
	...
	{0xAC0B, 0x4C, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// AWB_R_SCENE_RATIO_UPPER
	{0xAC0C, 0x29, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// AWB_B_SCENE_RATIO_LOWER
	...
	{0xC8CE, 0x008C,}, 	// CAM_AWB_CCM_M_RG_GAIN
	{0xC8D0, 0x011B,}, 	// CAM_AWB_CCM_M_BG_GAIN
	{0xC8D2, 0x00CC,}, 	// CAM_AWB_CCM_R_RG_GAIN
	...
	{0xC90E, 0x0000,}, 	// CAM_AWB_AWB_WEIGHTS_7
       ...
       {0xC966, 0x8C, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_LL_START_SATURATION
	...
	{0xC947, 0x7E, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 1129_tune 7c-->7f CAM_AWB_K_R_R
	{0xC948, 0x80, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_AWB_K_G_R
	{0xC949, 0x7D, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_AWB_K_B_R
	...
	{0xC9C8, 0x38, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_LL_START_CONTRAST_LUMA_PERCENTAGE
	{0xC9C9, 0x0D, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_LL_STOP_CONTRAST_LUMA_PERCENTAGE
	...
	{0xC9C2, 0x029A,}, 	// CAM_LL_STOP_CONTRAST_BM
...
static struct msm_camera_i2c_reg_conf as0260_cfg_preview_fps[][AS0260_PREVIEW_FPS_PARM] = {
	{//[5fps]
		...
		{0xAC0B, 0x5A, MSM_CAMERA_I2C_BYTE_DATA, 0, 0 },	// 20130123_SKT_57-->5a_AWB_R_SCENE_RATIO_UPPER	//0x46
              {0xAC0C, 0x25, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 20130123_SKT_ADD_29-->28AWB_B_SCENE_RATIO_LOWER
		...
		{0xD01D, 0x32, MSM_CAMERA_I2C_BYTE_DATA, 0, 0 }, 	// 20130123_SKT_8e-->32_PGA_ZONE_LO_1  //0x8E
		{0xD021, 0x39, MSM_CAMERA_I2C_BYTE_DATA, 0, 0 },	// 20130123_SKT_PGA_ZONE_HI_2  //0x87
		{0xC947, 0x87, MSM_CAMERA_I2C_BYTE_DATA, 0, 0 },	// CAM_AWB_K_R_R  //0x80
		...
		{0xC8CE, 0x0092,},	// CAM_AWB_CCM_M_RG_GAIN  //0x8C
	...
	{//[9fps]
		...
		{0xD01C, 0x96, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_LO_0	//0x8C
		{0xD020, 0x9A, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_1  //0x90
		{0xD01D, 0x32, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 20130123_SKT_8e-->32_  //0x8E
		{0xD021, 0x39, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 20130123_SKT_PGA_ZONE_HI_2  //0x87
		{0xC947, 0x87, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_AWB_K_R_R  //0x80
		{0xC877, 0x05, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_HUE_ANGLE	//0xfe
		{0xC966, 0x64, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_LL_START_SATURATION
	...
	{//[11fps]
		...
		{0xD01C, 0x96, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_LO_0	//0x8C
		{0xD020, 0x9A, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_1  //0x90
		{0xD01D, 0x32, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	//20130123_SKT_8e-->32_ PGA_ZONE_LO_1  //0x8E
		{0xD021, 0x39, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	//20130123_SKT_PGA_ZONE_HI_2  //0x87
		{0xC947, 0x87, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_AWB_K_R_R  //0x80
		{0xC877, 0x05, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_HUE_ANGLE	//0xfe
		{0xC966, 0x64, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_LL_START_SATURATION
	...
	{//[28fps]
		...
		{0xD020, 0x9A, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_1  //0x90
		{0xD01D, 0x32, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	//20130123_SKT_8e-->32_ PGA_ZONE_LO_1  //0x8E
		{0xD021, 0x39, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	//20130123_SKT_ PGA_ZONE_HI_2  //0x87
		{0xC947, 0x87, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_AWB_K_R_R  //0x80
		{0xC877, 0x05, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_HUE_ANGLE	//0xfe
		{0xC966, 0x64, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_LL_START_SATURATION
		{0xC8CE, 0x0092,}, 	// CAM_AWB_CCM_M_RG_GAIN  //0x8C
	...
	{//[30fps]
		...
		{ 0xC88A, 0x0200  ,}, 	// CAM_AET_AE_MAX_VIRT_DGAIN  //0x0100
		{0xAC0B, 0x4C, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 0103_reddish_modi 46-->4c AWB_R_SCENE_RATIO_UPPER	//0x46
        {0xAC0C, 0x29, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 20130123_SKT_ADD_AWB_B_SCENE_RATIO_LOWER
		...
		{0xD01C, 0x8C, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_LO_0	//0x8C
		{0xD020, 0x90, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_1  //0x90
		{0xD01D, 0x82, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_LO_1  //0x82
		{0xD021, 0x87, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// PGA_ZONE_HI_2  //0x87
		{0xC947, 0x7E, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// CAM_AWB_K_R_R  //0x80
	...
	{//[variable frame]
		...
		{0xAC0B, 0x4C, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 0102_reddish_modi 46-->4c AWB_R_SCENE_RATIO_UPPER	//0x46
		{0xAC0C, 0x29, MSM_CAMERA_I2C_BYTE_DATA, 0, 0}, 	// 20130123_SKT_ADD_AWB_B_SCENE_RATIO_LOWER
